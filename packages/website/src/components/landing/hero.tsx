...
export const Hero = () => (
  <section className="mx-auto flex max-w-3xl flex-col items-center gap-8 px-6 py-24 text-center md:py-32">
    <div className="inline-flex items-center gap-2 rounded-full border border-fd-border bg-fd-muted/60 px-4 py-1.5 text-xs font-mono text-fd-muted-foreground">
