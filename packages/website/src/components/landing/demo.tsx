...
import { COMMAND, DEMO_VIDEO_URL } from "./constants";

export const Demo = () => (
  <GridSection>
    <div className="relative overflow-hidden bg-gradient-to-b from-fd-muted/40 to-fd-muted/80 dark:from-fd-muted/20 dark:to-fd-muted/40">
