...
- **Next.js 15**: las advertencias destacan que `fetch` y los handlers GET no usan caché por defecto.
- **Next.js 16+**: las advertencias priorizan la guía de Cache Components (`"use cache"`, etiquetas de caché, revalidación dirigida).
- **Otras/versiones desconocidas**: las advertencias usan una guía de políticas de caché agnóstica al framework.
