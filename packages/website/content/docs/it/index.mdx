...
| <DynamicLink href="/[lang]/docs/rules/image-optimization">Ottimizzazione Immagini</DynamicLink> | 3 | `unoptimized` globale, `sizes` mancante, pattern remoti troppo ampi |
