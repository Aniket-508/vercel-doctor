...
| <DynamicLink href="/[lang]/docs/rules/image-optimization">Otimização de Imagens</DynamicLink> | 3 | `unoptimized` global, `sizes` ausente, padrões remotos amplos demais |
